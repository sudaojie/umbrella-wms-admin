...
public class HttpUtils {
     ...
     * @return 所代表远程资源的响应结果
     */
    public static String doPostByParams(String url, String param) {
    ...
    public static String doPostByJson(String url, Map<String, Object> param) {
        ...
        try {
            ...
            // 创建参数列表
            if (param != null) {
                log.info("HttpUtil,Post请求,请求参数:{}", JSON.toJSONString(param));
    ...
    public static String sendPost(String url1, String params) throws Exception {
