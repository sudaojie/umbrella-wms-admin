...
/**
 * @author hewei
 * @description 照明系统全局定时开启任务
 */
@Slf4j
@Component("WcsLightStartBatchTask")
public class WcsLightStartBatchTask {
    ...
    public void startBatchTask(String jobId) {

        log.info(" ========任务号{}; 定时执行WCS照明系统全局开启任务开始执行======= ", jobId);
        ...
        log.info(" ========任务号{}; 定时执行WCS照明系统全局开启任务结束执行======= ", jobId);
    }
