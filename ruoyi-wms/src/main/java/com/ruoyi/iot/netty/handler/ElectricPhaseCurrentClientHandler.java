...
import com.ruoyi.iot.packet.electric.rsp.ElectricReadCurrentRsp;
...
@Slf4j
@Component
public class ElectricPhaseCurrentClientHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        String a = "";
        ElectricReadCurrentRsp electricReadCurrentRsp = ElectricReadCurrentRsp.hexStrToObj(message,a);
        ...
        WcsDeviceBaseInfo wcsDeviceBaseInfo = wcsDeviceBaseInfoService.getBaseMapper()
                .selectOne(new QueryWrapper<WcsDeviceBaseInfo>()
                        .eq("device_address", electricReadCurrentRsp.getAddressCode()).eq("device_type", WcsTaskDeviceTypeEnum.AMMETER.getCode()));
        ...
        if (ObjectUtil.isNotNull(wcsDeviceBaseInfo)) {
            ...
            if (CollUtil.isNotEmpty(infoList)) {
                infoList.forEach(e -> {
                    e.setPhaseCurrentA(String.valueOf(electricReadCurrentRsp.getCurrentA()))
                            .setPhaseCurrentB(String.valueOf(electricReadCurrentRsp.getCurrentB()))
                            .setPhaseCurrentC(String.valueOf(electricReadCurrentRsp.getCurrentC()))
                ...
                collectInfo.setPhaseCurrentA(String.valueOf(electricReadCurrentRsp.getCurrentA()))
                        .setPhaseCurrentB(String.valueOf(electricReadCurrentRsp.getCurrentB()))
                        .setPhaseCurrentC(String.valueOf(electricReadCurrentRsp.getCurrentC()))
                        .setCollectTime(new Date()).setDeviceInfoId(wcsDeviceBaseInfo.getId()).setPostalAddress(electricReadCurrentRsp.getAddressCode())
                        .setPhaseVoltageA("0").setPhaseVoltageB("0").setPhaseVoltageC("0");
