...
/**
 * 读取电压、电流、功率 DPT/DCT/DPQ Req
 */
@Data
@Slf4j
public class ElectricReadPhaseActiveEnergyDPTReq {
    ...
    public ElectricReadPhaseActiveEnergyDPTReq() {
        this.addressCode = "01";
    ...
    public ElectricReadPhaseActiveEnergyDPTReq(String addressCode, String functionCode, String startAddress, String endAddress,
    ...
    public String toString() {
        ...
        log.info("总有功电能 send message: {}", message);
        return message;
    }
