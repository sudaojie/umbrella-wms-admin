...
@Data
@Slf4j
public class ElectricReadPhaseActivePowerReq {
    ...
    public ElectricReadPhaseActivePowerReq() {
        this.addressCode = "01";
    ...
    public ElectricReadPhaseActivePowerReq(String addressCode, String functionCode, String startAddress,
                                           String endAddress, String dataLength, String checkCodeLow, String checkCodeHigh) {
    ...
    public String toString() {
        ...
        log.info("有功功率 send message: {}", message);
        return message;
    }
