...
@Data
@Slf4j
public class ElectricReadVoltageReq {
    ...
    public ElectricReadVoltageReq(String addressCode, String functionCode, String startAddress, String endAddress,
    ...
    public String toString() {
        ...
        log.info("电压 send message: {}", message);
        return message;
    }
