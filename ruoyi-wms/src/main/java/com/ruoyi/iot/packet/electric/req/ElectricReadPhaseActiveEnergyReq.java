...
@Data
@Slf4j
public class ElectricReadPhaseActiveEnergyReq {
    ...
    public ElectricReadPhaseActiveEnergyReq() {
        this.addressCode = "01";
    ...
    public ElectricReadPhaseActiveEnergyReq(String addressCode, String functionCode, String startAddress, String endAddress,
