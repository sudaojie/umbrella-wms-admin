...
@Data
@Slf4j
public class ElectricReadPhaseActiveEnergyPTReq {
    ...
    public ElectricReadPhaseActiveEnergyPTReq() {
        this.addressCode = "01";
    ...
    public ElectricReadPhaseActiveEnergyPTReq(String addressCode, String functionCode, String startAddress, String endAddress,
