...
@Data
@Slf4j
public class ElectricReadCurrentReq {
    ...
    public ElectricReadCurrentReq(String addressCode, String functionCode, String startAddress, String endAddress,
    ...
    public String toString() {
        ...
        log.info("电流 send message: {}", message);
        return message;
    }
